            ...
            <tr>
                <td class="pl-0 py-8">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <a href="{{ route('mentor.listCourse', ['id' => $mentor->id]) }}"
                ...
                <td>
                    @if ($mentor->is_active == 1)
                        <a href="{{ route('mentor.actived', $mentor->id) }}"
