    ...
    <div class="collapse-horizontal collapse show" id="collapseWidthExample">
        <div class="card vh-100 overflow-auto rounded-0 w-280px w-sm-400px">
            ...
            <div class="card-header bg-light rounded-0">
                <h1 class="mt-2 fs-5">Hoành thành khóa học {{ $course->title }} - {{ $course->lessons->count() }} khóa
                    học trong 1</h1>
            </div>
                                                    ...
                                                    <div>
                                                        <div
                                                            ...
                                                            <div class="position-relative d-flex align-items-center">
                                                                <a href="#"
                                                                    onclick="sideBar(this,'{{ route('client.lesson.show', $lesson->id) }}')"
                                                                    class="btn btn-danger-soft btn-round btn-sm mb-0 stretched-link position-static remove-all-click">
                                                                    @if ($lesson->lesson_user)
