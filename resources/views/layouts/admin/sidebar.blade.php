        ...
        <ul class="menu-nav">
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('mentor.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">DANH SÁCH GIẢNG VIÊN</span>
                            </a>
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.discount.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">THU NHẬP GIẢNG VIÊN</span>
                            </a>
                        </li>
                    </ul>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="javascript:;" class="menu-link menu-toggle">
                    ...
                    <span class="menu-text">QUẢN LÝ NGƯỜI KIỂM DUYỆT</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="menu-submenu">
                    <i class="menu-arrow"></i>
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.user.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">DANH SÁCH NGƯỜI KIỂM DUYỆT</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.skill.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">DANH SÁCH SKILL</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="javascript:;" class="menu-link menu-toggle">
                    ...
                    <span class="menu-text">QUẢN LÝ CHUYÊN MÔN</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="menu-submenu">
                    <i class="menu-arrow"></i>
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.specialize.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">DANH SÁCH CHUYÊN MÔN</span>
                            </a>
                        </li>
                    </ul>
                </div>
