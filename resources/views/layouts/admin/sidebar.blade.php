    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav">
            <li class="menu-item" aria-haspopup="true">
                <a href="{{ route('admin.statistical.home') }}" class="menu-link">
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('mentor.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">Danh sách quản lý Lead</span>
                            </a>
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('teacher.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">Danh sách quản lý giảng viên</span>
                            </a>
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.course.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">Danh sách khoá học</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.discount.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">Danh sách mã giảm giá</span>
                            </a>
                        </li>
                    </ul>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                <a href="javascript:;" class="menu-link menu-toggle">
                    ...
                    <span class="menu-text">Quản lý cấp bậc khóa học</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="menu-submenu">
                    <i class="menu-arrow"></i>
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.skill.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">Danh sách cấp bậc</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.statistical.teacherList') }}" class="menu-link">
                                <i class="menu-bullet menu-bullet-line">
                                    <span></span>
                                </i>
                                <span class="menu-text">Thu nhập các giảng viên</span>
                            </a>
                        </li>
                    </ul>
                    <ul class="menu-subnav">
