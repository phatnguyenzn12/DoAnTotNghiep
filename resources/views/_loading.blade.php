...
<div class="data-loading">
    <div class="d-flex flex-column align-content-center align-items-center">
        <h1 class="loading__content">Đang tải</h1>
        <?xml version="1.0" encoding="utf-8"?>
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            style="margin: auto; background: rgba(73, 68, 68, 0); display: block; shape-rendering: auto;" width="200px"
            ...
            <circle cx="84" cy="50" r="10" fill="#e15b64">
                ...
                <animate attributeName="fill" repeatCount="indefinite" dur="1s" calcMode="discrete"
                    keyTimes="0;0.25;0.5;0.75;1" values="#e15b64;#abbd81;#f8b26a;#f47e60;#e15b64" begin="0s">
                </animate>
            </circle>
