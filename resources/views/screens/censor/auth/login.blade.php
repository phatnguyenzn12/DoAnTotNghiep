...
@section('content')
    ...
    <div class="lg:p-12 max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
        <form class="lg:p-10 p-6 space-y-3 relative bg-white shadow-xl rounded-md" method="POST" action="{{ route('censor.handleLogin') }}">
            @csrf
            <h1 class="lg:text-2xl text-xl font-semibold mb-6"> Đăng nhập Censor </h1>
            <div>
