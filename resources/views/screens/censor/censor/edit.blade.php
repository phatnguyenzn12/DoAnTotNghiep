...
@section('title', 'Trang sửa Censor')
@section('content')
                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Chỉnh sửa Censor</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin::Form-->
                        ...
                        <form class="form" id="kt_form" method="POST" enctype="multipart/form-data" action="">
                            ...
                            <div class="card-toolbar">
                                <a href="{{route('censor.index')}}" class="btn btn-light-primary font-weight-bolder mr-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-solid" type="text" name="name"
                                                    value="@isset($censor->name){{ $censor->name }}@endisset" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-solid" type="email" name="email"
                                                    value="@isset($censor->email){{ $censor->email }}@endisset" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-solid">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid"
                                                        value="@isset($censor->number_phone){{ $censor->number_phone }}@endisset" placeholder="Phone" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
