            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <div
                        ...
                        <img src="/frontend/images/client/science.svg" alt="Icon">
                    </div>
                    <div class="p-2 bg-white shadow rounded-3 position-absolute top-0 end-0 me-5">
                        <img src="/frontend/images/client/angular.svg" alt="Icon">
                    </div>
                    <div
                        ...
                        <img src="/frontend/images/client/figma.svg" alt="Icon">
                    </div>
                    <!-- Icon logos END -->
                    ...
                    <div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block"
                        style="background:url(/frontend/images/pattern/01.png) no-repeat center center; background-size:cover;">
                        <p class="text-white">Our daily new students</p>
                        <!-- Avatar group -->
                        <ul class="avatar-group mb-0">
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="/frontend/images/avatar/01.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="/frontend/images/avatar/02.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="/frontend/images/avatar/03.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="/frontend/images/avatar/04.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                    ...
                    <div class="position-relative">
                        <img src="/frontend/images/element/07.png" alt="">
                    </div>
                </div>
                <!-- Right content END -->
            </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
                        ...
                        <div class="ms-4 h6 fw-normal mb-0">
                            ...
                            <p class="mb-0">Các sinh viên trực tuyến</p>
                        </div>
                    </div>
                </div>
                <!-- Counter item -->
                        ...
                        @forelse($courses as $course)
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="/frontend/images/courses/4by3/08.jpg" class="card-img-top"
                                        alt="course image">
                                    <!-- Card body -->
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="{{ route('client.course.show', ['slug' => $course['slug'],'course' => $course['id']]) }}">{{ $course['title'] }}</a></h5>
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                ...
                                                56m</span>
                                            <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>{{ $course['lesson'] }}
                                                Bài học</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tiny-slider-inner pb-1" data-autoplay="true" data-arrow="true" data-edge="2"
                        ...
                        <div>
                            <div class="card action-trigger-hover border bg-transparent">
                                <!-- Image -->
                                <img src="/frontend/images/courses/4by3/14.jpg" class="card-img-top" alt="course image">
                                <!-- Ribbon -->
