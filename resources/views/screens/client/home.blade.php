...
@section('content')
    ...
    <div class="row">
        <div class="tiny-slider arrow-round arrow-creative arrow-dark arrow-hover">
            <div class="tiny-slider-inner" data-autoplay="true" data-edge="2" data-arrow="true" data-dots="false" data-items="1"
                data-items-xl="1" data-items-md="1" data-items-xs="1">
                <section class="position-relative osition-relative overflow-hidden pt-5 pt-lg-3">
                    ...
                    <div class="container position-relative mt-0 mt-sm-5 pt-5">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7">
                                <!-- Image -->
                                <img src="/frontend/images/element/05.svg" alt="">
                            </div>
                        </div>
                    </div>
                </section>
