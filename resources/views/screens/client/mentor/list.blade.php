            ...
            <div class="row g-4 justify-content-center">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="d-sm-flex justify-content-sm-between mb-2 mb-sm-3">
                                            <div>
                                                <h5 class="card-title mb-0"><a href="#">{{$item->name}}</a></h5>
                                                <p class="small mb-2 mb-sm-0">Sdt: {{$item->number_phone}}</p>
                                            </div>
				...
				<div class="card shadow p-2">
					<div class="row g-0">
						<!-- Image -->
						<div class="col-md-4">
							<img src="/frontend/images/instructor/02.jpg" class="rounded-3" alt="...">
						</div>
				...
				<div class="card shadow p-2">
					<div class="row g-0">
						<!-- Image -->
						<div class="col-md-4">
							<img src="/frontend/images/instructor/03.jpg" class="rounded-3" alt="...">
						</div>
				...
				<div class="card shadow p-2">
					<div class="row g-0">
						<!-- Image -->
						<div class="col-md-4">
							<img src="/frontend/images/instructor/04.jpg" class="rounded-3" alt="...">
						</div>
				...
				<div class="card shadow p-2">
					<div class="row g-0">
						<!-- Image -->
						<div class="col-md-4">
							<img src="/frontend/images/instructor/06.jpg" class="rounded-3" alt="...">
						</div>
				...
				<div class="card shadow p-2">
					<div class="row g-0">
						<!-- Image -->
						<div class="col-md-4">
							<img src="/frontend/images/instructor/07.jpg" class="rounded-3" alt="...">
						</div>
				...
				<div class="card shadow p-2">
					<div class="row g-0">
						<!-- Image -->
						<div class="col-md-4">
							<img src="/frontend/images/instructor/08.jpg" class="rounded-3" alt="...">
						</div>
				...
				<div class="card shadow p-2">
					<div class="row g-0">
						<!-- Image -->
						<div class="col-md-4">
							<img src="/frontend/images/instructor/09.jpg" class="rounded-3" alt="...">
						</div>
