                    ...
                    <div>
                        ...
                        @if (isset($lesson))
                            <p style="margin: 20 0 0 0; margin-bottom: 15px; ">
                                Xin chào {{ $lesson->chapter->mentor->name }},<br>
                            </p>
                            @if ($lesson->is_edit == 1)
                                <p>Admin đã chấp thuận chỉnh sửa bài học: {{ $lesson->title }}</p>
                            @else
                                <p>Admin không chấp thuận chỉnh sửa bài học: {{ $lesson->title }}</p>
                            @endif
                        ...
                        @else
                            ...
                            <p>Admin đã chấp thuận chỉnh sửa tất cả bài học</p>
