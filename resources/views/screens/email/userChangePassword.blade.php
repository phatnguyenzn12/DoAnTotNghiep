                ...
                <div class="wrapper"
                    ...
                    <div>
                        ...
                        <p style="margin: 20 0 0 0; margin-bottom: 15px; ">
                            Xin chào {{ $db->name }},<br>
                            Bạn đang yêu cầu đổi mật khẩu tại hệ thống của chúng
                            tôi.
                        </p>
                        <p style=" margin-bottom: 15px;">Để đổi mật khẩu vui lòng
                            nhấn vào nút xác minh bên dưới</p>
                        <p align="center"
                            style="box-sizing: border-box; padding: 0; font-size: 16px; vertical-align: top; padding-bottom: 15px;"
                            valign="top">
                            <a href="{{ route('auth.handleChangePassword', ['id' => $db->id, 'token' => $db->remember_token]) }}"
                                ...
                                target="_blank">Xác nhận tài khoản</a>
                        </p>
                        <p>Cảm ơn {{ $db->name }}!</p>
