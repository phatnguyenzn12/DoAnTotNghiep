                    ...
                    <div>
                        ...
                        @if (isset($lesson))
                            <p style="margin: 20 0 0 0; margin-bottom: 15px; ">
                                Xin chào {{ $lesson->chapter->course->mentor->name }},<br>
                            </p>
                            <p>Giảng viên: {{ $lesson->chapter->mentor->name }}</p>
                        ...
                        @else
                            <p style="margin: 20 0 0 0; margin-bottom: 15px; ">
                                Xin chào {{ $chapter->course->mentor->name }},<br>
                                Bạn đã đăng ký tài khoản tại hệ thống học trực tuyến Eduport.
                            </p>
                            <p>Giảng viên: {{ $chapter->mentor->name }}</p>
