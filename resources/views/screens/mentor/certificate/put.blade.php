        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('mentor.certificate.update',$certificate->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $certificate->title }}" name="title" class="form-control"
                                    placeholder="Nhập tiêu đề">
                            </div>
                            <div class="form-group">
                                <label>Mô tả chứng nhận</label>
                                <textarea id="editor" rows="5" class="form-control" value="{{ $certificate->description }}" name="description"
                                    id="">{{ $certificate->description }}</textarea>
                            </div>
                            <div class="form-group">
